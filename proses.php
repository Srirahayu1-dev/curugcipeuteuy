...
if(isset($_POST['nama_pemesanan'])){
	...
	$sql = "INSERT INTO pemesanan (nama_pemesanan, hp_pemesan, waktu_wisata, hari_wisata, jumlah_peserta, total, paket_inap, paket_transport, paket_makan) value ('$nama_pemesanan','$hp_pemesan','$waktu_wisata','$hari_wisata','$jumlah_peserta','$total_tagihan','$paket_inap','$paket_transport','$paket_makan')";
